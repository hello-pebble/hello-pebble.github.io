...
<div class="resume-header">
  <div class="resume-identity">
    ...
    <span class="resume-tagline">운영 효율과 서비스 안정성을 높이는 백엔드 개발자 · Java · Spring</span>
  </div>
...
<p class="resume-lead"><strong>Java·Spring 백엔드 실무 3년 10개월.</strong> 공공데이터·제조 공정·문서 처리 시스템을 개발하고, 배포와 장애 대응까지 담당했습니다.</p>
...
<p class="resume-summary">상세 근거와 설계 판단은 <a href="{{ '/resume/career-description/' | relative_url }}">경력기술서</a>와 각 <a href="{{ '/portfolio/' | relative_url }}">포트폴리오</a>에서 확인할 수 있습니다. 개발 과정에서 Claude Code·Codex를 활용하고 있으며, 활용 방식을 정리해두었습니다 — <a href="{{ '/ai/' | relative_url }}">활용 방식 보기</a></p>
