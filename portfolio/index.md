...
<section class="portfolio-section" aria-labelledby="personal-projects">
  ...
  <div class="portfolio-grid">
    ...
    <a class="portfolio-card" href="{{ '/portfolio/backoffice-ai/' | relative_url }}">
      ...
      <p class="portfolio-summary">Vercel·Railway·Supabase로 화면·API·워커를 분리 배포 · 긴 자동화는 요청 서버 밖의 Python 워커로 넘기고 단일 실행 잠금·검토 전 발행 차단으로 운영 경계를 설계 · 컨테이너 재배포에도 Gmail OAuth 토큰이 남도록 PostgreSQL에 보관</p>
