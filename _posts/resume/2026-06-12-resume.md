...
> **Java·Spring 백엔드 3년 10개월** · 공공데이터 조회 · 제조 공정 관리 · 문서 처리 시스템 설계와 운영 · Docker·GitLab CI 기반 배포 환경 구축
...
<div class="resume-draft">
  <h2 class="resume-section-heading">Training</h2>
  <ul>
    <li><span class="resume-placeholder">작성 필요 — 부트캠프·직업훈련·사내 교육 이수 이력 (없으면 이 섹션 삭제)</span></li>
  </ul>

  <h2 class="resume-section-heading">Languages</h2>
  <ul>
    <li><span class="resume-placeholder">작성 필요 — 어학 시험 점수·회화 수준 (없으면 이 섹션 삭제)</span></li>
  </ul>
